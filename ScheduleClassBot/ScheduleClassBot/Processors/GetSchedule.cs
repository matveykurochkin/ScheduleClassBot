...
internal static class GetSchedule
{
    // ReSharper disable once InconsistentNaming
    private static readonly Logger _logger = LogManager.GetCurrentClassLogger();

    // ReSharper disable once InconsistentNaming
    private static readonly string _numerator = "ЧИСЛИТЕЛЬ";

    // ReSharper disable once InconsistentNaming
    private static readonly string _denominator = "ЗНАМЕНАТЕЛЬ";
    ...
    private static string GetTodaySchedule(string[] dayArr, DayOfWeek today)
    {
    ...
    private static string GetTomorrowSchedule(string[] dayArr, DayOfWeek today)
    {
        var todayIndex = Array.IndexOf(dayOfWeek, today.ToString());
