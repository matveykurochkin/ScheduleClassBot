...
internal static class GetSessionSchedule
{
    ...
    public static async Task GetSessionOnPMI(ITelegramBotClient botClient, Update update, Message message, CancellationToken cancellationToken)
    {
        ...
        {
            _logger.Error($"Error view session schedule for group PMI. Error message: {ex.Message}");
        }
    }

    public static async Task GetSessionOnPRI(ITelegramBotClient botClient, Update update, Message message, CancellationToken cancellationToken)
    {
        try
        {
        ...
        {
            _logger.Error($"Error view session schedule for group PRI. Error message: {ex.Message}");
        }
    }
}
